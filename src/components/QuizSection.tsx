...
const quizItems = [
  {
    title: "Kuis Dasar Fintech",
    description: "Uji pemahaman dasar-dasar financial technology dan transformasi digital keuangan.",
    url: "https://quizizz.com/admin/quiz/xxxxxxxx"
  },
  {
    title: "Kuis Literasi Keuangan Digital",
    description: "Tes pengetahuanmu tentang pengelolaan keuangan di era digital.",
    url: "https://quizizz.com/admin/quiz/yyyyyyyy"
  },
  {
    title: "Kuis Keamanan Transaksi Online",
    description: "Seberapa paham kamu tentang keamanan siber dalam transaksi digital?",
    url: "https://quizizz.com/admin/quiz/zzzzzzzz"
  },
  {
...
const QuizSection = () => {
  return (
    <section id="kuis-interaktif" className="py-16 md:py-24 bg-card relative z-10">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sunshine/20 text-sunshine mb-4">
            ...
            <span className="text-sm font-semibold uppercase tracking-wider">Kuis</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4">
            Kuis Interaktif
          </h2>
          <p className="text-muted-foreground text-lg">
            Uji pemahaman fintech-mu dan dapatkan sertifikat serta lencana pencapaian!
          </p>
        </div>
